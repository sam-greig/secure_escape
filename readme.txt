...
To gain insights into additional details of the game development process it is recommended to install GameMaker from their official website and opening the
Secure_Escape.yyp file using the GameMaker application. https://gamemaker.io/en/download
